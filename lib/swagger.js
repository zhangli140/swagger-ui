  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, resource) {
      ...
      if (this.nickname == null) {
        this.api.fail("SwaggerOperations must have a nickname.");
      }
      if (this.path == null) {
        this.api.fail("SwaggerOperation " + nickname + " is missing path.");
      }
      if (this.httpMethod == null) {
        this.api.fail("SwaggerOperation " + nickname + " is missing httpMethod.");
      }
    ...
    SwaggerOperation.prototype.pathXml = function() {
      return this.path.replace("{format}", "xnl");
    };
